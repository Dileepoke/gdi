...
document.write('<link rel="stylesheet" href="//raw.githack.com/Dileepoke/gdi/main/style.css">');
// markdown Standby
...
if(dark){document.write('<style>* {box-sizing: border-box}body{color:rgba(255,255,255,.87);background-color:#222}.mdui-theme-primary-'+main_color+' .mdui-color-theme{background-color:#232427!important}</style>');}
